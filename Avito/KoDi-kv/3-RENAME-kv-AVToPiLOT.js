...
// var modem = (`
	...
	function testModem1(){var x=iimGetLastExtract(1); x=x.split('.')[0]; x+="."; y=iimGetLastExtract(1);y=y.split('.')[1]; x+=y; return x;}	
	function testModem2(){var x=iimGetLastExtract(2); x=x.split('.')[0]; x+="."; y=iimGetLastExtract(2);y=y.split('.')[1]; x+=y; return x;}
	...
	iimPlayCode(`
							...
							add counter 1
							SET !EXTRACT {{counter}}
							FILEDELETE NAME=C:\\Users\\user\\OneDrive\\недвижка\\автопилот-ринейм.txt
							SAVEAS TYPE=EXTRACT FOLDER=C:\\Users\\user\\OneDrive\\недвижка FILE=автопилот-ринейм.txt
