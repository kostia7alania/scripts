...
`
	...
	function сборОтчета(строка) {iimSet("useragent", useragent); iimSet("айпишки", айпишки); iimSet("строка",строка); iimPlayCode(отчет);  iimSet("строка",строка);  iimSet("useragent", useragent); iimPlayCode(ADD); }; 
