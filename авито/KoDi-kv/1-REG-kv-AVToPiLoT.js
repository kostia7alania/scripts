			//недвижка\\			
iimPlayCode(`wait seconds=5\n TAB CLOSEALLOTHERS\n tab open\n tab open\n SET !DATASOURCE_DELIMITER ;\n CMDLINE !DATASOURCE C:\\Users\\user\\Onedrive\\недвижка\\автопилот-рег+адд.txt\n SET !DATASOURCE_COLUMNS 1\n SET !DATASOURCE_LINE 1\n SET !EXTRACT {{!COL1}}`)
...
{	iimDisplay('Входим в админку+Меняем айпи. Строка: '+строка+'('+ДоСтроки+')');
	...
	var	avtoPilotCount = `set counter {{строка}}\n ADD counter 1\n SET !EXTRACT {{counter}}\n FILEDELETE NAME=C:\\Users\\user\\OneDrive\\недвижка\\автопилот-рег+адд.txt\n SAVEAS TYPE=EXTRACT FOLDER=C:\\Users\\user\\OneDrive\\недвижка FILE=автопилот-рег+адд.txt`
	...
	URL GOTO=https://m.avito.ru/add
					   ...
					   'Генерируем АДРЕС и связанный с ним ид_МЕТРО:	
						...
						set этажей {{!COL8}}
						set метро {{!COL9}}
						set словамиМетро {{!COL10}}
						set адрес {{!COL11}}
 						set началоОписалова {{!COL12}}
						set конецОписалова {{!COL13}}
			...
			'КАРТИНКА:
						TAG POS=1 TYPE=INPUT:FILE FORM=NAME:NoFormName ATTR=ID:image_upload CONTENT=C:\\Users\\User\\OneDrive\\недвижка\\фото-для-подачи-кв\\kodi{{строка}}kv.jpg			
						wait seconds=5
						TAG POS=1 TYPE=INPUT:FILE FORM=NAME:NoFormName ATTR=ID:image_upload CONTENT=C:\\Users\\User\\OneDrive\\недвижка\\фото-для-подачи-кв\\kodi{{строка}}.1kv.jpg			
						wait seconds=5
						TAG POS=1 TYPE=INPUT:FILE FORM=NAME:NoFormName ATTR=ID:image_upload CONTENT=C:\\Users\\User\\OneDrive\\недвижка\\фото-для-подачи-кв\\kodi{{строка}}.2kv.jpg			
						wait seconds=5
						TAG POS=1 TYPE=INPUT:FILE FORM=NAME:NoFormName ATTR=ID:image_upload CONTENT=C:\\Users\\User\\OneDrive\\недвижка\\фото-для-подачи-кв\\kodi{{строка}}.3kv.jpg			
						wait seconds=5
						TAG POS=1 TYPE=INPUT:FILE FORM=NAME:NoFormName ATTR=ID:image_upload CONTENT=C:\\Users\\User\\OneDrive\\недвижка\\фото-для-подачи-кв\\kodi{{строка}}.4kv.jpg			
						wait seconds=5		
			'клик по ПРОДОЛЖИТЬ:
