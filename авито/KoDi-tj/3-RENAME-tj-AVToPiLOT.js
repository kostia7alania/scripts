...
iimPlayCode(`SET !REPLAYSPEED fast\n  CMDLINE !DATASOURCE C:\\Users\\user\\Onedrive\\tj\\автопилот-ринейм-tj.txt\n SET !DATASOURCE_COLUMNS 1\n SET !DATASOURCE_LINE 1\n set !EXTRACT {{!COL1}}\n  CMDLINE !DATASOURCE C:\\Users\\user\\Onedrive\\tj\\автопилот-рег+адд-tj.txt\n SET !DATASOURCE_COLUMNS 1\n SET !DATASOURCE_LINE 1\n add !EXTRACT {{!COL1}}`)

var СоСтроки = Number(iimGetLastExtract(1)); var ДоСтроки = Number(iimGetLastExtract(2)-1);
...
// var modem = (`
	...
	iimPlayCode(`
							...
							SCREENSHOT TYPE=Browser FOLDER=C:\\Users\\user\\Onedrive\\tj\\результаты\\скрины\\{{строка}}  FILE={{строка}}---3переим-tj-каб-{{!NOW:dd.mm.yyyy}}-[{{!NOW:hh:nn}}]-{{баня7}}.jpg
							...
							SAVEAS TYPE=EXTRACT FOLDER=C:\\Users\\user\\Onedrive\\tj\\результаты FILE=3---переименовашки-tj.txt
							SCREENSHOT TYPE=Page FOLDER=C:\\Users\\user\\Onedrive\\tj\\\результаты\\скрины\\ FILE={{строка}}---3переименовашки-tj-{{!NOW:dd.mm.yyyy}}-[{{!NOW:hh:nn}}]-{{баня7}}.jpg
							wait seconds=5
							url goto=2ip.ru
							Set counter {{строка}}
							add counter 1
							SET !EXTRACT {{counter}}
							FILEDELETE NAME=C:\\Users\\user\\OneDrive\\tj\\автопилот-ринейм-tj.txt
							SAVEAS TYPE=EXTRACT FOLDER=C:\\Users\\user\\OneDrive\\tj FILE=автопилот-ринейм-tj.txt
